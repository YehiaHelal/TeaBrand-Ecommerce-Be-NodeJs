...
const resetpasswordemail_post = async (req, res, next) => {
  ...
  //   html: `<a href="https://www.shoponlinemarket.cloud/resetpassword/${token}">https://www.shoponlinemarket.cloud/resetpassword/${token}</a>
...
const orderConfirmedemail_post = async (req, res, next) => {
  ...
  if (findOrder.mailSent === false) {
    ...
    //      <a href="https://www.shoponlinemarket.cloud/collections">https://www.shoponlinemarket.cloud/collections</a>
    //      <br><br>
